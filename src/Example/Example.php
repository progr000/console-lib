<?php
namespace Maksym\Console\Example;
...
class Example extends ConsoleDriver
{
    ...
    public function validate(array $actions)
    {
        if (!isset($this->some_any_name1_variable)) {
            var_dump("Validation fail", "--set-some-any-name1-variable=VALUE is required" , 'error');
            return false;
        }
    ...
    {
        var_dump("someAnyName1Method() executed" , 'info');
    }
    ...
    {
        var_dump("someAnyName2Method() executed" , 'info');
    }
